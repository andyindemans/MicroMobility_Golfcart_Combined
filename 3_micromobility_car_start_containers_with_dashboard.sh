...
docker container stop micromobility_car_navigation_container micromobility_car_object_avoidance_container micromobility_car_pilot_container micromobility_car_dashboard

#remove micromobility_car containers
docker container rm micromobility_car_navigation_container micromobility_car_object_avoidance_container micromobility_car_pilot_container micromobility_car_dashboard_container
...
docker run -d -it --net host --privileged --env-file cart-settings.txt --env="DISPLAY" -v $HOME/.Xauthority:/root/.Xauthority -v /dev/shm:/dev/shm -v $PWD/micromobility_car_dashboard/local/Project:/home/user/Projects --name micromobility_car_dashboard_container micromobility_car_dashboard /bin/bash
...
gnome-terminal --title="DASHBOARD CONTAINER" -- docker exec -it micromobility_car_dashboard_container bash
