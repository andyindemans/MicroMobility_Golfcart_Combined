...
class NavigationHandler(Node):
    def __init__(self):
        ...
        self.next_node_reached_subscription = self.create_subscription(Float64, 'distance_to_node', self.distance_to_node_callback, 10)
        ...
        self.delete_next_node_subscriber = self.create_subscription(Bool, 'delete_next_node', self.delete_next_node_callback, 10)
