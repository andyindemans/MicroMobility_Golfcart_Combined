...
#include "mm_interfaces/msg/detail/coordinate_msg__rosidl_typesupport_fastrtps_c.h"
...
using _CoordinateMsg__ros_msg_type = mm_interfaces__msg__CoordinateMsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CoordinateMsg__ros_msg_type * ros_message = static_cast<const _CoordinateMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: latitude
  {
  ...
  void * untyped_ros_message)
{
  ...
  _CoordinateMsg__ros_msg_type * ros_message = static_cast<_CoordinateMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: latitude
  {
    cdr >> ros_message->latitude;
  }
...
static uint32_t _CoordinateMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mm_interfaces__msg__CoordinateMsg(
...
{
  return max_serialized_size_mm_interfaces__msg__CoordinateMsg(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_CoordinateMsg = {
  "mm_interfaces::msg",
  "CoordinateMsg",
...
static rosidl_message_type_support_t _CoordinateMsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CoordinateMsg,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mm_interfaces, msg, CoordinateMsg)() {
  return &_CoordinateMsg__type_support;
}
