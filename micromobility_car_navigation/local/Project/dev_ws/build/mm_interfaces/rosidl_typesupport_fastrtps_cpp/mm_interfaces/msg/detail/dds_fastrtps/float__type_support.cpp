...
#include "mm_interfaces/msg/detail/float__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mm_interfaces::msg::Float & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mm_interfaces::msg::Float & ros_message)
{
  // Member: sensor_error
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const mm_interfaces::msg::Float *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mm_interfaces::msg::Float *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Float__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mm_interfaces::msg::Float *>(
...
{
  return max_serialized_size_Float(full_bounded, 0);
}

static message_type_support_callbacks_t _Float__callbacks = {
  "mm_interfaces::msg",
  "Float",
...
static rosidl_message_type_support_t _Float__handle = {
...
{
  return &mm_interfaces::msg::typesupport_fastrtps_cpp::_Float__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mm_interfaces, msg, Float)() {
  return &mm_interfaces::msg::typesupport_fastrtps_cpp::_Float__handle;
}
