...
class HeadingCalculator(Node):
    def __init__(self):
        ...
        self.draw_compas()
        self.subscription = self.create_subscription(CurrentNextLocation, 'coorpair', self.calculate_heading_callback,
                                                     10)
    ...
    def show_compas(self, angle):
        ...
        point2 = ((int)(point1[0] + length * math.cos(angle * math.pi / 180.0)),
