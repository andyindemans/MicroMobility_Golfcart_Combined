...
bool mm_interfaces__msg__camera_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mm_interfaces.msg._camera_image.CameraImage", full_classname_dest, 43) == 0);
  }
  mm_interfaces__msg__CameraImage * ros_message = _ros_message;
  {  // sensor_error
...
PyObject * mm_interfaces__msg__camera_image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mm_interfaces.msg._camera_image");
