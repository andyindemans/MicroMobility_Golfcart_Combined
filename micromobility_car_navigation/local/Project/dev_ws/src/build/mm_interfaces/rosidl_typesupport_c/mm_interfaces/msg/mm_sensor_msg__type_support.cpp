...
static const _MmSensorMsg_type_support_symbol_names_t _MmSensorMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mm_interfaces, msg, MmSensorMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mm_interfaces, msg, MmSensorMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mm_interfaces, msg, MmSensorMsg)() {
  return &::mm_interfaces::msg::rosidl_typesupport_c::MmSensorMsg_message_type_support_handle;
}
