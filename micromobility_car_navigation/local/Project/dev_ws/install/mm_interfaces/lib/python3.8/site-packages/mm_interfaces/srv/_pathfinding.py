...
class Pathfinding_Request(metaclass=Metaclass_Pathfinding_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.current_long = kwargs.get('current_long', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.current_long != other.current_long:
            return False
    ...
    def current_long(self, value):
        if __debug__:
            assert \
                ...
                "The 'current_long' field must be of type 'float'"
