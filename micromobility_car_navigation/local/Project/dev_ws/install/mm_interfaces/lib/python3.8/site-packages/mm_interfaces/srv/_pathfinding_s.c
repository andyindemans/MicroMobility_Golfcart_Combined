...
bool mm_interfaces__srv__pathfinding__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // current_long
    PyObject * field = PyObject_GetAttrString(_pymsg, "current_long");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->current_long = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // current_lat
...
PyObject * mm_interfaces__srv__pathfinding__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // current_long
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->current_long);
    {
      int rc = PyObject_SetAttrString(_pymessage, "current_long", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
