...
#ifndef MM_INTERFACES__SRV__DETAIL__PROXIMITY__FUNCTIONS_H_
#define MM_INTERFACES__SRV__DETAIL__PROXIMITY__FUNCTIONS_H_
...
/// Initialize srv/Proximity message.
/**
...
/// Finalize srv/Proximity message.
/**
...
/// Create srv/Proximity message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mm_interfaces__srv__Proximity_Request__init().
...
/// Destroy srv/Proximity message.
/**
 * It calls
 * mm_interfaces__srv__Proximity_Request__fini()
...
/// Initialize array of srv/Proximity messages.
/**
...
/// Finalize array of srv/Proximity messages.
/**
 * It calls
 * mm_interfaces__srv__Proximity_Request__fini()
...
/// Create array of srv/Proximity messages.
/**
 * It allocates the memory for the array and calls
 * mm_interfaces__srv__Proximity_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Proximity messages.
/**
 * It calls
 * mm_interfaces__srv__Proximity_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mm_interfaces__srv__Proximity_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mm_interfaces
...
/**
 * It calls
 * mm_interfaces__srv__Proximity_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mm_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mm_interfaces__srv__Proximity_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mm_interfaces
...
/**
 * It calls
 * mm_interfaces__srv__Proximity_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MM_INTERFACES__SRV__DETAIL__PROXIMITY__FUNCTIONS_H_
