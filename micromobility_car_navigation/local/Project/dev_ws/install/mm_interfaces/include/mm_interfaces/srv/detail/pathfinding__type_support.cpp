...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pathfinding_Request_message_member_array[3] = {
  {
    "current_long",  // name
    ...
    offsetof(mm_interfaces::srv::Pathfinding_Request, current_long),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mm_interfaces::srv::Pathfinding_Request, current_lat),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
