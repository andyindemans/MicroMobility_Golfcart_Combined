...
class Init_Pathfinding_Request_current_lat
{
public:
  explicit Init_Pathfinding_Request_current_lat(::mm_interfaces::srv::Pathfinding_Request & msg)
  : msg_(msg)
  {}
  Init_Pathfinding_Request_end_node_id current_lat(::mm_interfaces::srv::Pathfinding_Request::_current_lat_type arg)
  {
...
class Init_Pathfinding_Request_current_long
{
public:
  Init_Pathfinding_Request_current_long()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Pathfinding_Request_current_lat current_long(::mm_interfaces::srv::Pathfinding_Request::_current_long_type arg)
  {
    msg_.current_long = std::move(arg);
    return Init_Pathfinding_Request_current_lat(msg_);
  }
...
{
  return mm_interfaces::srv::builder::Init_Pathfinding_Request_current_long();
}
