...
static rosidl_typesupport_introspection_c__MessageMember Pathfinding_Request__rosidl_typesupport_introspection_c__Pathfinding_Request_message_member_array[3] = {
  {
    "current_long",  // name
    ...
    offsetof(mm_interfaces__srv__Pathfinding_Request, current_long),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mm_interfaces__srv__Pathfinding_Request, current_lat),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
