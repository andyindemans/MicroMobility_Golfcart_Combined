...
class Init_CoordinateMsg_id
{
public:
  explicit Init_CoordinateMsg_id(::mm_interfaces::msg::CoordinateMsg & msg)
  : msg_(msg)
  {}
  ::mm_interfaces::msg::CoordinateMsg id(::mm_interfaces::msg::CoordinateMsg::_id_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_CoordinateMsg_id heading(::mm_interfaces::msg::CoordinateMsg::_heading_type arg)
  {
    msg_.heading = std::move(arg);
    return Init_CoordinateMsg_id(msg_);
  }
